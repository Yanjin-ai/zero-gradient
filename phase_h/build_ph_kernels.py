...
# ---- G1: real NLI (SNLI) ----
build("post-backprop-phaseh-nli", "Post Backprop Phase H NLI", "ph_nli_kernel.ipynb", "kaggle_ph_nli",
...
build("post-backprop-phaseh-gsm", "Post Backprop Phase H Multi-step", "ph_gsm_kernel.ipynb", "kaggle_ph_gsm",
