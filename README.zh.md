...
│
├── phase_e*.py · c1_4b.py · adapt_sentiment.py       # 边界线:后训练能力上限(Phase E)
├── f1_data.py · f2_aux.py · h1_attn.py               # 边界线:ZeroBP 原生修法(Phase F)
├── v2_readout.py · v2_attn.py · v2_deepbp.py         # 边界线:结构探针(Phase G)
├── task_nli.py · task_arith.py                       # 共享合成任务
├── track1_sst2_4b.py · track1_radar.py · make_figures.py · build_track1_kernels.py
│
├── phase_h/                            # 对照:隔离的可训练注意力骨架(research-only)
│
├── paper/                             # 报告(英文 + 中文)
